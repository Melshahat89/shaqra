...
//       url: "site/b2bPayVisa",
//       type: 'post',
//       data: {'amount': amount, 'type': type, 'numberOfUsers': numberOfUsers},
//       success: function (data) {
//         console.log(data);
//           if(data.token){
...
// function KioskMasary(){

// $('#loading-spinner').show();
// $.ajax({
//     url: "site/b2bPayKiosk/masary",
//     type: 'post',
//     data: {'amount': amount, 'type': type, 'numberOfUsers': numberOfUsers},
//     success: function (data) {
//         if(data.payment_data){
