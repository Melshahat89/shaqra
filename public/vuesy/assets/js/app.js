...
Author: Meduo
Version: 1.0.0
Website: https://Meduo.in/
Contact: Meduo.in@gmail.com
File: Main Js File
*/
...
(function () {
    ...
    function setLanguage(lang) {
        if (document.getElementById("header-lang-img")) {
            if (lang == 'en') {
                document.getElementById("header-lang-img").src = "/vuesy/assets/images/flags/us.jpg";
            } else if (lang == 'sp') {
                document.getElementById("header-lang-img").src = "/vuesy/assets/images/flags/spain.jpg";
            }else if (lang == 'gr') {
                document.getElementById("header-lang-img").src = "/vuesy/assets/images/flags/germany.jpg";
            } else if (lang == 'it') {
                document.getElementById("header-lang-img").src = "/vuesy/assets/images/flags/italy.jpg";
            } else if (lang == 'ru') {
                document.getElementById("header-lang-img").src = "/vuesy/assets/images/flags/russia.jpg";
            }
    ...
    function getLanguage() {
        ...
        request.open("GET", '/vuesy/assets/lang/' + language + '.json');
    ...
    function changeDirection(id) {
        ...
        //     document.getElementById('bootstrap-style').setAttribute('href', '/vuesy/assets/css/bootstrap.min.css');
        //     document.getElementById('app-style').setAttribute('href', '/vuesy/assets/css/app.min.css');
        //     sessionStorage.setItem("is_visited", "layout-direction-ltr");
        ...
        //     document.getElementById('bootstrap-style').setAttribute('href', '/vuesy/assets/css/bootstrap-rtl.min.css');
        //     document.getElementById('app-style').setAttribute('href', '/vuesy/assets/css/app-rtl.min.css');
