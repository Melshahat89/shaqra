...
function addNewB2cSubscriptionItem(){
    ...
    $.ajax({
        ...
        type: 'GET',
        url: '/lazyadmin/orders/addB2cSubscriptionItem/',

        success: function(data){

            tBody.append(
                "<tr class='courseitem'><td class='no'>" + i + "</td><td class='text-left'><h3></h3></td>"
                + "<td class='unit'>" + data.subtypes + "</td><td class='qty'><a class='button btn-danger'><span onclick='removeItem(this)' class='btn bg-deep-purple btn-circle waves-effect waves-circle waves-float'><i class='material-icons'>delete</i></span></a></td><td class='total'><input class='cost-input' required type='number' name='coursesCost[]'></td></tr>"
            )
