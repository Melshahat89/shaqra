...
class PermissionController extends AbstractController
{
    ...
    public function store(AddRequestPermission $request){
        ...
        $request->request->add(['controller_name' => class_basename($nameSpace)]);
         return $this->storeOrUpdate($request , null , 'lazyadmin/permission');
    }
    ...
    public function update($id , UpdateRequestPermission $request){
        ...
        $request->request->add(['namespace' => $nameSpace]);
        $request->request->add(['controller_name' => class_basename($nameSpace)]);
        return $this->storeOrUpdate($request , $id , 'lazyadmin/permission');
    }
    ...
    public function destroy($id){
        return $this->deleteItem($id , 'lazyadmin/permission')->with('sucess' , 'Done Delete permission From system');
    }
