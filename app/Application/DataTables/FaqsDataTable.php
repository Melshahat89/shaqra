...
class FaqsDataTable extends DataTable
{
    ...
    public function ajax()
    {
        return datatables()
             ->eloquent($this->query())
              ->addColumn('id', 'admin.faq.buttons.id')
             ->addColumn('edit', 'admin.faq.buttons.edit')
             ->addColumn('delete', 'admin.faq.buttons.delete')
             ->addColumn('view', 'admin.faq.buttons.view')
             /*->addColumn('name', 'admin.faq.buttons.langcol')*/
    ...
    public function query()
    {
		...
		if(request()->has("answer") && request()->get("answer") != ""){
				$query = $query->where("answer","like", "%".request()->get("answer")."%");
		}
