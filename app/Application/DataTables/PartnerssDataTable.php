...
class PartnerssDataTable extends DataTable
{
    /**
    ...
    public function ajax()
    {
        return datatables()
             ->eloquent($this->query())
              ->addColumn('id', 'admin.partners.buttons.id')
             ->addColumn('edit', 'admin.partners.buttons.edit')
             ->addColumn('delete', 'admin.partners.buttons.delete')
             ->addColumn('view', 'admin.partners.buttons.view')
             /*->addColumn('name', 'admin.partners.buttons.langcol')*/
...
//                    }',
    ...
    {
        return 'Partnersdatatables_' . time();
    }
}