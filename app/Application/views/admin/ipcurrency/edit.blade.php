...
@section('content')
    @component(layoutForm() , ['title' => trans('ipcurrency.ipcurrency') , 'model' => 'ipcurrency' , 'action' => isset($item) ? trans('home.edit')  : trans('home.add')  ])
         @include(layoutMessage())
        <form action="{{ concatenateLangToUrl('admin/ipcurrency/item') }}{{ isset($item) ? '/'.$item->id : '' }}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
		 ...
		 <div class="form-group {{ $errors->has("currency_rates") ? "has-error" : "" }}" > 
            ...
            <div class="form-group">
                <button type="submit" name="submit" class="btn btn-default" >
                    ...
                    {{ trans('home.save') }}  {{ trans('ipcurrency.ipcurrency') }}
                </button>
            </div>
        </form>
    @endcomponent
