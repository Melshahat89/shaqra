<script>
    ...
    function getControllers() {
        ...
        $.ajax({
            type: "get",
            url: '{{ concatenateLangToUrl('lazyadmin/getControllerByType/') }}/' + type_id,
    ...
    function getMethods() {
        ...
        $.get('{{ concatenateLangToUrl('lazyadmin/getMethodByController/') }}/' + controller + '/' + type_id, function (response) {
