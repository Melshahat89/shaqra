...
@section('content')
    ...
    <form class="card-body" action="{{ concatenateLangToUrl('lazyadmin/group/item') }}{{ isset($item) ? '/'.$item->id : '' }}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
            ...
            <div class="form-group">
                <div class="">
                    <label class="col-md-2 col-form-label" for="">{{ trans('group.per_role') }}</label>
            ...
            <div class="form-group">
                <div class="">
                    <label class="col-md-2 col-form-label" for="">{{ trans('group.permission') }}</label>
