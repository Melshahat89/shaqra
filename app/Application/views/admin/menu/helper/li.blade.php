<li class="dd-item dd3-item" data-id="{{ $itemMenu['item']['id'] }}">
    ...
    <div class="dd3-content">
        ...
        <a href="{{ url('lazyadmin/deleteMenuItem/'. $itemMenu['item']['id']) }}" class="pull-right"><i class="material-icons">delete_forever</i></a>
                ...
                @endif
                    <li class="dd-item dd3-item" data-id="{{ $men['id'] }}">
                        ...
                        <div class="dd3-content">
                            ...
                            <a href="{{ url('lazyadmin/deleteMenuItem/'. $men['id']) }}" class="pull-right"><i class="material-icons">delete_forever</i></a>
                            <a href="#" data-url="{{ url('lazyadmin/updateMenuItem/'. $men['id']) }}" data-id="{{ $men['id'] }}" class="pull-right" data-toggle="modal" data-target="#defaultModal"><i class="material-icons">mode_edit</i></a>
                        </div>
                    </li>
                @if ($loop->last)
                    </ol>
