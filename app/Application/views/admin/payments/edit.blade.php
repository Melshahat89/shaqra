...
@endsection
 @section('content')
    @component(layoutForm() , ['title' => trans('payments.payments') , 'model' => 'payments' , 'action' => isset($item) ? trans('home.edit')  : trans('home.add')  ])
         @include(layoutMessage())
        <form class="card-body" action="{{ concatenateLangToUrl('lazyadmin/payments/item') }}{{ isset($item) ? '/'.$item->id : '' }}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
            @include("admin.payments.relation.user.edit")
     <div class="form-group {{ $errors->has("operation") ? "has-error" : "" }}" > 
   <label class="col-md-2 col-form-label" for="operation">{{ trans("payments.operation")}}</label>
   ...
   <label class="col-md-2 col-form-label" for="amount">{{ trans("payments.amount")}}</label>
   ...
   <label class="col-md-2 col-form-label" for="currency_id">{{ trans("payments.currency_id")}}</label>
   ...
   <label class="col-md-2 col-form-label" for="receiver_id">{{ trans("payments.receiver_id")}}</label>
   ...
   <label class="col-md-2 col-form-label" for="token">{{ trans("payments.token")}}</label>
   ...
   <label class="col-md-2 col-form-label" for="token_date">{{ trans("payments.token_date")}}</label>
   ...
   <label class="col-md-2 col-form-label" for="status">{{ trans("payments.status")}}</label>
   ...
   <label class="col-md-2 col-form-label" for="accept_source_data_type">{{ trans("payments.accept_source_data_type")}}</label>
   ...
   <label class="col-md-2 col-form-label" for="accept_id">{{ trans("payments.accept_id")}}</label>
   ...
   <label class="col-md-2 col-form-label" for="accept_pending">{{ trans("payments.accept_pending")}}</label>
   ...
   <label class="col-md-2 col-form-label" for="accept_order">{{ trans("payments.accept_order")}}</label>
   ...
   <label class="col-md-2 col-form-label" for="accept_amount_cents">{{ trans("payments.accept_amount_cents")}}</label>
   ...
   <label class="col-md-2 col-form-label" for="accept_success">{{ trans("payments.accept_success")}}</label>
   ...
   <label class="col-md-2 col-form-label" for="accept_data_message">{{ trans("payments.accept_data_message")}}</label>
   ...
   <label class="col-md-2 col-form-label" for="accept_profile_id">{{ trans("payments.accept_profile_id")}}</label>
   ...
   <label class="col-md-2 col-form-label" for="accept_source_data_sub_type">{{ trans("payments.accept_source_data_sub_type")}}</label>
   ...
   <label class="col-md-2 col-form-label" for="accept_hmac">{{ trans("payments.accept_hmac")}}</label>
   ...
   <label class="col-md-2 col-form-label" for="txn_response_code">{{ trans("payments.txn_response_code")}}</label>
   ...
   @endif
              <div class="form-group">
                <button type="submit" name="submit" class="btn btn-info w-md" >
                    ...
                    {{ trans('home.save') }}  {{ trans('payments.payments') }}
                </button>
            </div>
        </form>
    @endcomponent
