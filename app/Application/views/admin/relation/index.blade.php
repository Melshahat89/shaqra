...
@section('content')
    <form class="card-body" action="{{ concatenateLangToUrl('lazyadmin/relation/exe') }}" method="post">
        {{ csrf_field() }}
        <div class="row">
            <div class="col-lg-3">
                <div class="form-group">
                    <div class="">
                        <label class="col-md-2 col-form-label" for="">{{ trans('admin.primary_key') }}</label>
            ...
            <div class="col-lg-3">
                <div class="form-group">
                    <div class="">
                        <label class="col-md-2 col-form-label" for="">{{ trans('admin.foreign Key') }}</label>
            ...
            <div class="col-lg-3">
                <div class="form-group">
                    <div class="">
                        <label class="col-md-2 col-form-label" for="">{{ trans('admin.Enable foreign Keys') }}</label>
            ...
            <div class="col-lg-3">
                <div class="form-group">
                    <div class="">
                        <label class="col-md-2 col-form-label" for="">{{ trans('admin.Relation Type') }}</label>
            ...
            <div class="col-lg-3">
                <div class="form-group">
                    <div class="">
                        <label class="col-md-2 col-form-label" for="">{{ trans('admin.Col1') }}</label>
            ...
            <div class="col-lg-3">
                <div class="form-group">
                    <div class="">
                        <label class="col-md-2 col-form-label" for="">{{ trans('admin.Col2') }}</label>
            ...
            <div class="col-lg-3 mtmfc">
                <div class="form-group">
                    <div class="">
                        <label class="col-md-2 col-form-label" for="">{{ trans('admin.Forign Column') }}</label>
            ...
            <div class="col-lg-3 mtmtype">
                <div class="form-group">
                    <div class="">
                        <label class="col-md-2 col-form-label" for="">{{ trans('admin.Type many To Many') }}</label>
            ...
            <tr>
                ...
                <td>
                    @if($h->command != 'laraflat:rollback')
                        <form class="card-body" action="{{ concatenateLangToUrl('lazyadmin/relation/rollback') }}" method="post">
                            {{ csrf_field() }}
