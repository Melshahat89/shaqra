...
@section('content')
    <form class="card-body" action="{{ concatenateLangToUrl('lazyadmin/command/exe') }}" method="post">
        {{ csrf_field() }}
    ...
    <form class="card-body" action="{{ concatenateLangToUrl('lazyadmin/laravel/haveCommand') }}" method="post" id="otherForm" style="display: none">
        {{ csrf_field() }}
        <div class="form-group">
            <div class="">
                <label class="col-md-2 col-form-label" for="">{{ trans('user.Laraflat Model Name') }}</label>
