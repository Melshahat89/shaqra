<script>
    ...
    function name() {
        ...
        output += '<div class="form-group name">' +
                '<label class="col-md-2 col-form-label" for="name">{{ trans("contact.name") }}</label>' +
    ...
    function adminModel(value, show, showModel) {
        ...
        output += '<div class="form-group" style="' + s + '">' +
                '<label class="col-md-2 col-form-label" for="name">{{ trans("admin.name") }}</label>' +
    ...
    function addNewColumn() {
        ...
        output += '<div class="parent clearfix"><div class="row well "><div class="col-lg-6"><div class="form-group col-lg-12">' +
                '<label class="col-md-2 col-form-label" for="name">{{ trans("admin.col name") }}</label>' +
                ' <input type="text" name="colsName[' + count + ']" id="name"  class="form-control" required/>' +
                '</div>';
        output += '<div class="form-group col-lg-5">' +
                '<label class="col-md-2 col-form-label" for="name">{{ trans("admin.col type") }}</label>' +
        ...
        output += '<div class="form-group col-lg-6">' +
                '<label class="col-md-2 col-form-label" for="name">{{ trans("admin.lang") }}</label>' +
        ...
        output += '</div><div class="col-lg-6"><div class="form-group col-lg-12">' +
                '<label class="col-md-2 col-form-label" for="name">{{ trans("admin.col validation") }}</label><div class="row">';
    ...
    function appendModels() {
        ...
        output += '<div class="">';
        output += '<label class="col-md-2 col-form-label" for="">{{ trans('admin.Select Model') }}</label>';
