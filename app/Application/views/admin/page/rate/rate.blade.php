		...
		@php 
		 ...
		 @if($rateBefore == 0)
			<form method="post" action="{{ concatenateLangToUrl("admin/page/add/rate/".$item->id) }}" > {{ csrf_field() }}
			<div class="form-group" > 
				<label class="col-md-2 col-form-label" for="rate" > {{ trans("admin.Rate") }}</label >
