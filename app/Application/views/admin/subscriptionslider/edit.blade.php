...
@section('content')
    @component(layoutForm() , ['title' => trans('subscriptionslider.subscriptionslider') , 'model' => 'subscriptionslider' , 'action' => isset($item) ? trans('home.edit')  : trans('home.add')  ])
         @include(layoutMessage())
        <form action="{{ concatenateLangToUrl('lazyadmin/subscriptionslider/item') }}{{ isset($item) ? '/'.$item->id : '' }}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
		 ...
		 <div class="form-group {{ $errors->has("cta_link") ? "has-error" : "" }}" > 
            ...
            <div class="form-group">
                <button type="submit" name="submit" class="btn btn-default" >
                    ...
                    {{ trans('home.save') }}  {{ trans('subscriptionslider.subscriptionslider') }}
                </button>
            </div>
        </form>
    @endcomponent
