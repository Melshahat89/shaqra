        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body custom-rev p-0">
                    ...
                    <form class="clearfix" id="feedbackForm" action="{{ concatenateLangToUrl('talksreviews/item') }}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                    ...
                    <div class="input-group mb-20">
                        ...
                        <input name="talks_id" type="hidden" value="{{ $model->id }}">
                    </div>
