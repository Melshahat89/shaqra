<h2>{{ ucfirst(trans('admin.Random'))}} {{ ucfirst('subscriptionslider') }}</h2>
<hr>
@php $sidebarSubscriptionslider = \App\Application\Model\Subscriptionslider::inRandomOrder()->limit(5)->get(); @endphp
