<h2>{{ ucfirst(trans('admin.Random'))}} {{ ucfirst('promotionactive') }}</h2>
<hr>
@php $sidebarPromotionactive = \App\Application\Model\Promotionactive::inRandomOrder()->limit(5)->get(); @endphp
