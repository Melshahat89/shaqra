            ...
            <table border="0" cellspacing="0" cellpadding="0" height="100%" width="650" style="color:#000000; background:#ffffff; font-family: Arial, Calibri, sans-serif; font-size:13px; padding: 0;  margin: 0 auto;">
                <tr>
                    <td style="text-align: center;">
                        <hr>
                        <br><br>
                        <h1 style="color:#3fa46a; font-weight: 700;">A student has passed an exam, .</h1>


                        <h1 style="font-size: 40px; margin: 0;">
                            Student's Email , {{$user['email']}}
                        </h1>
                        <br/>
                        <h1 style="font-size: 40px; margin: 0;">
                            Course Name , {{$course->title_en}}
                        </h1>
                        <br/>
                        <h1 style="font-size: 40px; margin: 0;">
                            <a href="{{$returnUrl}}">Click here for more details.</a>
                        </h1>
                        <br/>
                        <br><br><br>
                ...
                <tr style="background-color: #3c3c3c; height: 200px;">
                    <td valign="middle">
                        <p style="text-align: center; color: #ffffff;">
                            ...
                            <br>
                            © 2020 <a href="https://meduo.net" style="text-decoration: underline;color: #ffffff;">MEDUO</a>. All rights reserved.
