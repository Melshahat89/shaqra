...
@push('css')
<link href="{{ asset('website') }}/css/front/dga-design-system.css?v=4.1" rel="stylesheet">
<link rel="preconnect" href="https://fonts.googleapis.com">
<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
<link href="https://fonts.googleapis.com/css2?family=IBM+Plex+Sans+Arabic:wght@300;400;500;600;700;800&display=swap" rel="stylesheet">
<style>
body > br, body > b { display: none !important; }
</style>
@endpush
...
{{-- ══════════════════════════════════════════════
     HERO
══════════════════════════════════════════════ --}}
<section class="dga-hero" aria-label="الشهادات الاحترافية">
    <div class="dga-hero-inner">
        ...
        <div class="dga-hero-text">
            <span class="dga-hero-eyebrow">
                ...
                منصة الشهادات الاحترافية
            </span>
            <h1>{{ trans('professionalcertificates.professionalcertificates') }}</h1>
            <p>دورات تدريبية معتمدة من نخبة أفضل المدربين والخبراء — تعلّم في أي وقت ومن أي مكان.</p>
            <div class="dga-hero-btns">
            ...
            <div class="dga-hero-kpis">
                <div class="dga-kpi">
                    <span class="dga-kpi-n">+1,000</span>
                    <span class="dga-kpi-l">دورة معتمدة</span>
                </div>
                <div class="dga-kpi-sep"></div>
                <div class="dga-kpi">
                    <span class="dga-kpi-n">+50,000</span>
                    <span class="dga-kpi-l">متعلم</span>
                </div>
                <div class="dga-kpi-sep"></div>
                <div class="dga-kpi">
                    <span class="dga-kpi-n">+200</span>
                    <span class="dga-kpi-l">مدرب</span>
                </div>
            </div>
        </div>

        <div class="dga-hero-card">
            <p class="dga-hero-card-label">ابحث عن دورتك</p>
            <form action="{{ url('/allcourses/category') }}" method="GET" class="dga-hero-search">
                ...
                <input type="text" name="key" placeholder="اكتب اسم الدورة أو التخصص..." autocomplete="off">
                <button type="submit">بحث</button>
            </form>
            @if(isset($categories) && $categories->count())
            <p class="dga-hero-card-label" style="margin-top:18px;">تصفح سريع:</p>
            <div class="dga-hero-tags">
                @foreach($categories->take(5) as $cat)
                    <a href="{{ url('/allcourses/category/'.$cat->slug) }}" class="dga-hero-tag">{{ $cat->name_lang }}</a>
                @endforeach
            </div>
            @endif
        </div>
    ...
    {{-- wave bottom --}}
    <div class="dga-hero-wave">
        <svg viewBox="0 0 1440 54" fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none">
            <path d="M0 54L1440 54L1440 20C1200 54 960 0 720 10C480 20 240 54 0 20L0 54Z" fill="#F9FAFB"/>
        </svg>
    </div>
</section>
...
{{-- ══════════════════════════════════════════════
     STATS BAR
══════════════════════════════════════════════ --}}
<div class="dga-statsbar">
    <div class="dga-statsbar-inner">
        <div class="dga-sbar-item">
            <span class="dga-sbar-n">+1,000</span>
            <span class="dga-sbar-l">دورة تدريبية</span>
        </div>
        <div class="dga-sbar-div"></div>
        <div class="dga-sbar-item">
            <span class="dga-sbar-n">+50,000</span>
            <span class="dga-sbar-l">متعلم مسجل</span>
        </div>
        <div class="dga-sbar-div"></div>
        <div class="dga-sbar-item">
            <span class="dga-sbar-n">+200</span>
            <span class="dga-sbar-l">مدرب معتمد</span>
        </div>
        <div class="dga-sbar-div"></div>
        <div class="dga-sbar-item">
            <span class="dga-sbar-n">98%</span>
            <span class="dga-sbar-l">رضا المتعلمين</span>
        </div>
    </div>
</div>
                ...
                <article class="dga-card">
                    <a href="{{ url('/courses/view/'.$course->slug) }}" class="dga-card-img{{ $isPlaceholder ? ' dga-card-img-placeholder' : '' }}">
                        ...
                        <div class="dga-card-placeholder">
                            <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.2"><path d="M22 10v6M2 10l10-5 10 5-10 5z"/><path d="M6 12v5c3 3 9 3 12 0v-5"/></svg>
