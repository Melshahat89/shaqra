        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light p-0">
                ...
                <div class="dropdown-content">
                    <div class="navigation-primary">
                        <ul class="collapse navbar-collapse pr-2 pl-2 navbar-nav " id="navbarSupportedContent" style="margin: revert;">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{url('/professional-certificates')}}">
            ...
            @if(Auth::check())
                <div class="pt-2 {{ isMobile() ? 'w-100 d-flex justify-content-between' : ''}}">
                    ...
                    <div class="d-inline-block desktop-account-info-padding align-self-center"><a href="{{LaravelLocalization::getLocalizedURL((config('app.locale') == 'en') ? 'ar':'en') }}" style="color: #244092;font-weight: bold;"><i class="fas fa-globe"></i>
