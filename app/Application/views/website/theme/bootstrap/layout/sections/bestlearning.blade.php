...
@if(userCountry()['code'] == "EG")
	@if($data->discount_egp > 0)
		...
		<div class="course_card item promoted-course" style="min-width: 100%;--colorcode: {{isset($data->categories->color_code) ? $data->categories->color_code : '#E6E6E6'}}" data-awards="<?php echo round($data->discount_egp) ?>% {{trans('home.discount')}}">
	@else
...
@else
	@if($data->discount_usd > 0)
		@php $discountApplied = 1; @endphp
        <div class="course_card item promoted-course" style="min-width: 100%;--colorcode: {{isset($data->categories->color_code) ? $data->categories->color_code : '#E6E6E6'}}" data-awards="<?php echo round($data->discount_usd) ?>% {{trans('home.discount')}}">
    @else
        <div class="course_card" style="min-width: 100%;">
