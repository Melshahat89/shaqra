...
<div class="pull-{{ getDirection() }} col-lg-9">
        ...
        <form action="{{ concatenateLangToUrl('trainingdisclosure/item') }}{{ isset($item) ? '/'.$item->id : '' }}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
		 ...
		 <div class="form-group {{ $errors->has("service") ? "has-error" : "" }}" > 
            ...
            <div class="form-group">
                <button type="submit" name="submit" class="btn btn-default" >
                    ...
                    {{ trans('website.Update') }}  {{ trans('website.trainingdisclosure') }}
                </button>
            </div>
        </form>
</div>
