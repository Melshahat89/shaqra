...
<div class="content">
    ...
    .content {
        ...
        width:100%;
        height:100%;
        background:transparent url('https://igtsservice.com/website/images/certificate-with-logos.jpg') no-repeat 0 0;
    ...
    <div class="extra-logos" style="position: absolute;left:0;right:0;top:620px;text-align:center;">
        @foreach($logos as $logo)
            <img src="https://igtsservice.com/uploads/files/{{$logo}}" 
                style="
                height: 120px;
                margin-right: 18px;
                border-radius: 67px;
    ...
    <img src="https://igtsservice.com/website/images/igts-verify-certificate-qr.png" style="position: absolute;height: 90px;top: 695px;left: 860px;">
    <p style="margin:0;padding:0;position: absolute;height: 90px;top: 678px;left: 860px;font-size: 14px;">#{{$certificateId}}</p>
    <p style="margin:0;padding:0;position: absolute;height: 90px;top: 785px;left: 860px;font-size: 14px;">Scan to verify</p>
    @endif
</div>