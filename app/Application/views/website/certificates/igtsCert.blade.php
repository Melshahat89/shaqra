...
<div class="content">
    ...
    <div class="content_text">
        <p style="position: absolute; left: 0; right: 0; font-size: 50px; top: 410px; color: #005B8F;"><?php echo $name; ?></p>
        ...
        <p style="direction: rtl; margin-bottom: 0;text-transform:uppercase; font-family: 'Poppins'; font-size: 28px;font-weight: 700; position: absolute; right: 0; left: 0; top: 565px; color: #005B8F;"><?php echo  $course->title_en;?></p>
