...
<div class="course_add_comment hide">
    ...
    <form class="clearfix" id="feedbackForm" action="{{ concatenateLangToUrl('consultationsreviews/item') }}" method="post" enctype="multipart/form-data">
        {{ csrf_field() }}
        ...
        <div class="input-group mb-20">
            ...
            <input name="consultation_id" type="hidden" value="{{ $id }}">
        </div>
